...
## 2. Схема инфраструктуры приложения
...
*Стоимость **Yandex API Gateway** 120,00 ₽ — цена за 1 миллион вызовов API-шлюза 100 000 вызовов не тарифицируются*

| Этап           | Ресурс                    | Характеристика                                          | Стоимость в месяц |
|----------------|---------------------------|---------------------------------------------------------|--------------------|
| Начальное      | API Gateway               | Yandex API Gateway (до 1 100 000 запросов)            | 120 ₽          |
...
| Этап                    | Ресурс                    | Характеристика                                                 | Стоимость в месяц |
|-------------------------|---------------------------|----------------------------------------------------------------|--------------------|
| Тестирование партнёрами | API Gateway               | Yandex API Gateway (примерно 5 100 000 запросов)  | 600 ₽            |
...
| Этап         | Ресурс                    | Характеристика                                                    | Стоимость в месяц |
|--------------|---------------------------|-------------------------------------------------------------------|--------------------|
| Продовое     | API Gateway               | Yandex API Gateway (примерно 25 100 000)       | 3 000 ₽           |
